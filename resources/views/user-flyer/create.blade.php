                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('menu-designer.index') }}" class="btn btn-sm btn-primary">{{ __('Back to List') }}</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush" id="db-table">
                            ...
                            <tbody>
                                ...
                                <td class="d-flex">
                                    <a href="{{ route('menu-designer.show', $template->id) }}" class="btn btn-warning btn-sm">Use</a>
                                </td>
                                </tr>
                                @endforeach
                            </tbody>
