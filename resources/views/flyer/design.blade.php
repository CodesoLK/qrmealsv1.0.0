...
<div  class="pageLoader" id="pageLoader"></div>
        ...
        <div class="row">
            <div class="col">
                <div class="card border-0">
                    <div class="card-body get-width" style="overflow-x:auto">
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{ route('flyer.store') }}" class="submit-template-form form-group mb-2 d-flex justify-content-between">
                            @csrf
    ...
    <script>
        ...
        function parseLayout() {
            var local_template = getFromStorage()
            if(local_template) {
                initializeLayout(local_template.layout.width, local_template.layout.height)
                if(local_template.theme) {
                    parseTheme(local_template.theme)
                }
                if(local_template.layers) {
                    parseLayers(local_template.layers)
                }
            } else {
                initializeLayout(INITIAL_WIDTH, INITIAL_HEIGHT)
                saveLayout(INITIAL_WIDTH, INITIAL_HEIGHT, null)
